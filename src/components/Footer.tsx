...
const Footer = () => {
  return (
    <footer className="bg-black text-white border-t border-gray-800 mt-auto">
      <div className="container mx-auto max-w-screen-xl py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About Us</h3>
            <p className="text-gray-300 text-sm">
              Bizzigo Pro connects businesses with clients through our comprehensive marketplace platform.
            </p>
          </div>

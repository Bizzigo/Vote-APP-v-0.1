...
const RecentVendors = () => {
  ...
  const isOnline = (vendorId: string) => {
    ...
    <div className="my-8">
      ...
      <div className="flex flex-col space-y-4">
        {recentVendors.map((vendor, index) => (
          <div 
            key={vendor.id} 
            className="w-full bg-card animate-scale-in border border-border/40 shadow-sm transition-all duration-400 hover:shadow-md hover:border-border/80 p-4 rounded-md"
          >
            <div className="flex">
              {/* Left side - Logo */}
              <div className="mr-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className={`h-2 w-2 rounded-full ${isOnline(vendor.id) ? 'bg-green-500' : 'bg-gray-400'}`}></span>
                </div>

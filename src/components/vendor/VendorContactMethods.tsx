    ...
    <div className="flex flex-wrap items-center gap-2 mt-3">
      {hasPhone && (
        <a 
          ...
          className="flex items-center gap-1.5 bg-primary text-white px-2.5 py-1.5 rounded-md hover:bg-primary/90 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1"
          title={phoneNumber}
        >
      ...
      {hasWhatsapp && (
        <a 
          ...
          className="flex items-center justify-center bg-gray-700 text-white p-2 rounded-md hover:bg-gray-600 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1"
          title="WhatsApp"
        >
